...
import { ChevronDownIcon, ChevronRightIcon, BellIcon, LockClosedIcon, GlobeAltIcon, ShieldCheckIcon, ArrowDownTrayIcon, QuestionMarkCircleIcon, ArrowRightOnRectangleIcon, MoonIcon, SunIcon } from '@heroicons/react/24/outline';
...
export default function Settings() {
  ...
  const settingsSections = [
    ...
    { id: 'access', label: 'Access and permission', icon: LockClosedIcon },
    { id: 'language', label: 'Language settings', icon: GlobeAltIcon },
    { id: 'privacy', label: 'Data and privacy', icon: ShieldCheckIcon },
    { id: 'backup', label: 'Backup and recovery option', icon: ArrowDownTrayIcon },
    { id: 'support', label: 'Help and support', icon: QuestionMarkCircleIcon },
            ...
            <div className="max-w-4xl">
              ...
              {expandedSection === 'support' && (
                <div className={`${darkMode ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'} border rounded-2xl shadow-lg p-8`}>
                  ...
                  <p className={`${darkMode ? 'text-gray-400' : 'text-gray-600'} mb-4`}>Contact our support team for assistance.</p>
