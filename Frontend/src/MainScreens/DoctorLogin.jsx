      ...
      <div className="px-4 md:px-8 py-4 flex justify-between items-center">
        ...
        <div className="flex gap-4 md:gap-8 flex-wrap justify-center">
          <button 
            ...
            className="text-white font-bold text-xs md:text-sm hover:text-green-200 transition-colors duration-300 transform hover:scale-105 active:scale-95"
          >
            WELCOME
          </button>
          <button 
      ...
      <div className="flex-1 flex items-center justify-center px-4 py-8">
        <div className="w-full max-w-sm">
          ...
          <div className="text-center mb-6 md:mb-8">
            <img src={logo} alt="One Trust Healthchain Logo" className="h-16 md:h-20 w-auto object-contain mx-auto" />
          </div>
