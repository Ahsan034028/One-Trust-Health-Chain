...
const menuItems = [
  { id: 'dashboard', label: 'Dashboard', icon: Bars3Icon, path: '/patient' },
  { id: 'view', label: 'View Reports', icon: DocumentTextIcon, path: '/patient/view' },
  { id: 'download', label: 'Downloaded Reports', icon: ArrowDownTrayIcon, path: '/patient/download' },
  { id: 'profile', label: 'Profile', icon: UserCircleIcon, path: '/patient/profile' },
  { id: 'settings', label: 'Settings', icon: Cog6ToothIcon, path: '/patient/settings' },
];
